...
//     protected abstract appearProcess(animation: AnimationOptions): TransitionOptions<number>
//     protected abstract disappearProcess(animation: AnimationOptions): TransitionOptions<number>
